...
static void retract_z_probe() {
    ...
    //destination[X_AXIS] = 64.0;   //customize!
    //destination[Y_AXIS] = 38.25;  //customize!
    //destination[Z_AXIS] = 30;     //customize!
    destination[X_AXIS] = Z_PROBE_RETRACT_SCREW_X;
    destination[Y_AXIS] = Z_PROBE_RETRACT_SCREW_Y;
    destination[Z_AXIS] = Z_PROBE_RETRACT_SCREW_Z;
    prepare_move_raw();
    ...
    feedrate = homing_feedrate[Z_AXIS]/10;
    //destination[Z_AXIS] = current_position[Z_AXIS] - 28;    //customize!
    destination[Z_AXIS] = current_position[Z_AXIS] - Z_PROBE_RETRACT_DOWN;
    prepare_move_raw();

    feedrate = homing_feedrate[Z_AXIS];
    //destination[Z_AXIS] = current_position[Z_AXIS] + 38;    //customize!
    destination[Z_AXIS] = current_position[Z_AXIS] + Z_PROBE_RETRACT_DOWN + 10;
    prepare_move_raw();
    st_synchronize();
    #endif //SERVO_ENDSTOPS
}

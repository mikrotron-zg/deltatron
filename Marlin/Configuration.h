...
#define STRING_CONFIG_H_AUTHOR "(Mikrotron, Deltatron)" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "Deltatron"
...
#define X_MAX_POS DELTA_PRINTABLE_RADIUS + 15 //need this for z-probe retraction
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  // Note: this feature occupies 10'206 byte
    ...
    // is used to esimate the plane of the print bed
      ...
      #define ABL_PROBE_PT_2_X 69.28
      #define ABL_PROBE_PT_2_Y -40
      #define ABL_PROBE_PT_3_X -69.28
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 130}   //E WAS 155
...
#define ABS_PREHEAT_HPB_TEMP 0  //WAS 100
